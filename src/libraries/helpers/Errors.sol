...
library Errors {
  ...
  string public constant PRIORACCANNOT_BE_ZERO = '3';
  ...
  string public constant GROUP_ALREADY_EXISTS = '102';
  string public constant GROUP_NOT_EXISTS = '103';
  string public constant ASSET_ALREADY_EXISTS = '104';
  string public constant ASSET_NOT_EXISTS = '105';
  ...
  string public constant ASSET_LIST_NOT_EMPTY = '112';
  string public constant GROUP_LIST_NOT_EMPTY = '113';
}
