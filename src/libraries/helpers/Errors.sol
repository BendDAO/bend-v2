...
library Errors {
  ...
  string public constant YIELD_EXCEED_USER_SUPPLY = '509';
  string public constant YIELD_EXCEED_USER_LOCKED = '510';
  string public constant YIELD_EXCEED_MANAGER_LOCKED = '511';
