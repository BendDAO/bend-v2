...
contract TestIntegrationBorrow is IntegrationTest {
  ...
  function testShouldBorrowUSDTWhenHasETH() public {
    ...
    tsBorrower1.borrowERC20(tsCommonPoolId, address(tsUSDT), tsLowInterestGroupId, usdtAmount, address(this));
  }
  ...
  function testShouldBorrowERC20WhenHasERC721() public {
    ...
    tsBorrower1.borrowERC20(tsCommonPoolId, address(tsWETH), tsLowInterestGroupId, 10 ether, address(this));
  }
}
